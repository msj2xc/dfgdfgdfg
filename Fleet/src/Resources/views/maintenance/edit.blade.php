{{Form::model($maintenance,array('route' => array('maintenance.update', $maintenance->id), 'method' => 'PUT','class'=>'needs-validation','novalidate')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::text('charge_bear_by', null, array('class' => 'form-control','required'=>'required','placeholder'=>__('Enter Charge Bear By'))) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('maintenance_date', __('Maintenance Date'),['class'=>'form-label']) }}<x-required></x-required>
                {{ Form::date('maintenance_date', null, array('class' => 'form-control','required'=>'required','placeholder'=>__('Enter Service Date'))) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">

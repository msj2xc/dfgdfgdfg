                        ...
                        <div class="card-inner  d-flex justify-content-between">
                            <div class="card-content">
                                <div class="theme-avtar bg-white">
                                    <i class="ti ti-truck-delivery text-danger"></i>
                                </div>
                                <h3 class="mt-3 mb-0 text-danger">{{ __('Total Yet To Start Booking') }}</h3>
                            </div>
                ...
                <div class="col-sm-6 col-12">
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            ...
                            <h3 class="mt-3 mb-0">{{ __('Total On Going Booking') }}</h3>
                            </div>
                    ...
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            <div class="card-content">
                                ...
                                <h3 class="mt-3 mb-0">{{ __('Total Complete Booking') }}</h3>
                            </div>
                    ...
                    <div class="dashboard-project-card">
                        <div class="card-inner d-flex justify-content-between">
                            <div class="card-content">
                                ...
                                <h3 class="mt-3 mb-0">{{ __('Total Cancelled Booking') }}</h3>
                            </div>

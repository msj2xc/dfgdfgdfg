                        ...
                        <div class="card-inner  d-flex justify-content-between">
                            <div class="card-content">
                                <div class="theme-avtar bg-white">
                                    <i class="ti ti-manual-gearbox text-danger"></i>
                                </div>
                                <h3 class="mt-3 mb-0 text-danger">{{ __('Total Maintenance') }}</h3>
                            </div>
                ...
                <div class="col-sm-6 col-12">
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            ...
                            <h3 class="mt-3 mb-0">{{ __('Total Pending Maintenance') }}</h3>
                            </div>
                    ...
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            <div class="card-content">
                                ...
                                <h3 class="mt-3 mb-0">{{ __('Total Accept Maintenance') }}</h3>
                            </div>
                    ...
                    <div class="dashboard-project-card">
                        <div class="card-inner d-flex justify-content-between">
                            <div class="card-content">
                                ...
                                <h3 class="mt-3 mb-0">{{ __('Total Decline Maintenance') }}</h3>
                            </div>
